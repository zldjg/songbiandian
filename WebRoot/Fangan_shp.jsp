...
<div class="place">
    ...
    <span id="backbtn" style="margin-top:3px; float:right; margin-right:10px; display:none"><a href="Fangan_shp.jsp" class="longblue">返回</a></span>    
    <span id="tonggbtn" style="margin-top:3px; float:right; margin-right:10px; display:none"><a class="longblue">通过审批</a></span>
</div>
<!--/当前位置-->
    	...
    	<form name="del" method="post" action="#">        
          <table width="100%" class="zltab" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr class="tr1">
                ...
                <td id="shenhe1">否</td>
                <td id="time1"></td>
                <td><a style=" cursor:pointer" class="shpno" id="classchangeno">查看详细</a><a style=" cursor:pointer; display:none" id="classchangeyes" class="shpyes">查看详细</a>&nbsp;&nbsp;&nbsp;<a style=" cursor:pointer" id="tongguo">通过</a></td>
              </tr>                                  
              <tr class="tr2">
                <td colspan="8">
