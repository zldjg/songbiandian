...
<div class="mainindex" id="mainindex">
    <div class="maincon">
        <!--btns-->
        <ul class="btnOptions">
          <li><a href="Sbtz_new.jsp"><img src="images/btn-new.jpg" width="75" height="35" /></a></li>
          <li id="searchbtn"><img src="images/btn-sear.jpg" width="75" height="35" /></li>
          <li id="daorubtn"><img src="images/btn-daor.jpg" width="75" height="35" /></li>
          <li><a href="#"><img src="images/btn-daoc.jpg" width="75" height="35" /></a></li>
          <li><a href="#"><img src="images/download.png" width="75" height="35" /></a></li>
        ...
        <div class="ziliaobox">
        	...
        	<table width="100%"  class="zltab" border="0" cellspacing="0" cellpadding="0" id="searchtable" style="display:none">
              ...
              <tr class="tr1">
                ...
                <td width="30%">
                    <input class="inline laydate-icon" id="start" style=" width:150px" /> 
                </td>
              </tr>
              <tr class="tr1">
                <td width="10%"></td>
          ...
          <table width="100%" class="zltab" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr class="tr1">
                ...
                <td></td>
                <td></td>
                <td><a href="Sbtz_new.jsp">详细</a></td>
              </tr> 
              <tr class="tr1">
                <td class="tdc">2</td>
                <td></td>
