...
<div class="mainindex" id="mainindex">
    <div class="maincon">
        <!--btns-->
        <ul class="btnOptions">
          <li><a href="/getReportTemplate"><img src="images/btn-lr.jpg" width="75" height="35" /></a></li>
          <li><a href="Fangan_lr.jsp"><img src="images/btn-edit.jpg" width="75" height="35" /></a></li>
    	...
    	<form name="del" method="post" action="#">        
          <table width="100%" class="zltab" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr class="tr1">
                ...
                <td><a href="Fangan_details.jsp">查看详细</a></td>
              </tr> 
              <tr class="tr1">
