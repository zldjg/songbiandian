...
<div class="mainindex" id="mainindex">
    <div class="maincon">
        <!--btns-->
        <ul class="btnOptions">
          <li><a href="Dzqz_new.jsp"><img src="images/btn-add.jpg" width="75" height="35" /></a></li>
          <li><a href="Dzqz_new.jsp"><img src="images/btn-edit.jpg" width="75" height="35" /></a></li>
        ...
        <div class="ziliaobox">
        	...
        	<table width="100%"  class="zltab" border="0" cellspacing="0" cellpadding="0" id="searchtable" style="display:none">
              ...
              <tr class="tr1">
                <td width="10%" class="tdc2">签章名称：</td>
                <td width="20%"><input name="" type="text" class="dfinput" style=" width:85%;" /></td>
                <td width="10%" class="tdc2">创建时间：</td>
                <td width="20%"><input class="inline laydate-icon" id="start" style=" width:80%"></input>
                </td>
                <td width="40%">
    	...
    	<form name="del" method="post" action="#">    
          <table width="100%" class="zltab" border="0" cellspacing="0" cellpadding="0">
              <tr class="tr0">
                <td width="4%" class="tdc"><input name="chkAll" type="checkbox" id="chkAll" onclick="CheckAll(this.form)" value="checkbox"></input></td>
...
<div class="popupLayerL">
    <div id="blkh1" class="Mapdetails">
        <div class="detail-main">
            ...
            <div class="list_more">
                <img src="images/u15.png" width="680" height="455"></img>
            </div>
        </div>
    </div>
</div>
