        ...
        <div class="ziliaobox">
            <table width="100%"  class="zltab" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr class="tr1">
                ...
                <td width="80%"><input name='ID' type='checkbox' onclick="unselectall()" value='1' /> 模板管理  <input name='ID' type='checkbox' onclick="unselectall()" value='1' /> 方案管理 <input name='ID' type='checkbox' onclick="unselectall()" value='1' /> 方案审批 <input name='ID' type='checkbox' onclick="unselectall()" value='1' />  方案查询</td>
              </tr>
              <tr class="tr1">
                <td width="20%"  style="text-align:right">计量试验设备管理：</td>
                <td width="80%"><input name='ID' type='checkbox' onclick="unselectall()" value='1' /> 设备台账管理  <input name='ID' type='checkbox' onclick="unselectall()" value='1' /> 设备台账审核 <input name='ID' type='checkbox' onclick="unselectall()" value='1' /> 设备台账统计</td>
              </tr>
              <tr class="tr1">
                <td width="20%"  style="text-align:right">试验报告管理：</td>
                <td width="80%"><input name='ID' type='checkbox' onclick="unselectall()" value='1' /> 试验模板管理  <input name='ID' type='checkbox' onclick="unselectall()" value='1' /> 试验报告管理 <input name='ID' type='checkbox' onclick="unselectall()" value='1' /> 试验报告审核 <input name='ID' type='checkbox' onclick="unselectall()" value='1' />  试验报告统计</td>
              </tr>
              <tr class="tr1">
                <td width="20%"  style="text-align:right">人员资质管理：</td>
                <td width="80%"><input name='ID' type='checkbox' onclick="unselectall()" value='1' /> 资质证书管理</td>
              </tr>
              <tr class="tr1">
                <td width="20%"  style="text-align:right">电子签章管理：</td>
                <td width="80%"><input name='ID' type='checkbox' onclick="unselectall()" value='1' /> 签章管理</td>
              </tr>
              <tr class="tr1">
                <td width="20%"  style="text-align:right">系统设置：</td>
                <td width="80%"><input name='ID' type='checkbox' onclick="unselectall()" value='1' /> 权限设置 <input name='ID' type='checkbox' onclick="unselectall()" value='1' /> 用户管理</td>
              </tr>
              <tr class="tr1">
