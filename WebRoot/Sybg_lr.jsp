    ...
    <div class="maincon">
        ...
        <div class="ziliaobox">
            ...
            <table width="100%"  class="zltab" border="0" cellspacing="0" cellpadding="0">
              <tr class="tr0">
                <td colspan="4" class="tdc">试验报告录入</td>
              </tr>
              <tr class="tr1">
                <td width="10%" class="tdc2">所属站房：</td>
                <td width="40%">
                    <select class="select1" name="stationname"  style=" width:85%">
                        <option>请选择变电站</option>
                        <option>利民道</option>
                        <option selected="selected">黄花店新</option>
                        <option>白庙</option>
                    </select>
                </td>
                <td width="10%" class="tdc2">电压等级：</td>
                <td width="40%">
                    <select class="select1" name="voltage" style=" width:85%">
              ...
              <tr class="tr1">
                ...
                <td width="40%">
                    <select class="select1" name="equipmenttype"  style=" width:85%">
                        <option>请选择设备类型</option>
                        <option>电力变压器及电抗器</option>
                        <option>互感器</option>
                        <option>开关设备</option>
                        <option>电容器</option>
                        <option selected="selected">避雷器</option>
                    </select>
                </td>
                
                <td width="10%" class="tdc2">设备名称：</td>
                <td width="40%">
                    <select class="select1" name="equipmentname" >
              ...
              <tr class="tr1">
                <td width="10%" class="tdc2">试验性质：</td>
                <td width="40%">
                    <select class="select1" name="testattribute"  style=" width:85%">
                        <option>交接</option>
                    </select>
                </td>
                
                <td width="10%" class="tdc2">试验天气：</td>
                <td width="40%"><input name="weather" type="text" class="dfinput" style="width:90%;" /></td>
              </tr>
              <tr class="tr1">
                <td width="10%" class="tdc2">温度：</td>
                <td width="40%">
                    <input name="temperature" type="text" class="dfinput" style="width:20%;" /> °C
                </td>
                
                <td width="10%" class="tdc2">湿度：</td>
                <td width="40%"><input name="humidity" type="text" class="dfinput" style="width:20%;" /> %</td>
              </tr>
              <tr class="tr1">
